...
- The mainline has five independent units: signal/circuit, component workshop, logic/memory, machine, and algorithm.
- The signal/circuit unit, component workshop, and repair tasks share one circuit workbench and simulation model; the workshop builds publishable modules such as relays and logic gates.
